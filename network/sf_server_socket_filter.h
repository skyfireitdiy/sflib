...
namespace skyfire
{
    ...
    {
    public:
        virtual void send_filter(SOCKET sock,sf_pkg_header_t& header, byte_array& data) = 0;
        virtual void recv_filter(SOCKET sock,sf_pkg_header_t& header, byte_array& data) = 0;
