...
namespace skyfire {
    ...
    inline void
    sf_http_base_server::send_response_file_part__(SOCKET sock, const sf_http_response::response_file_info_t &file,
    ...
    template<typename T>
    bool sf_http_base_server::analysis_websocket_pkg__(SOCKET sock, const T *header, int &resolve_pos,
    ...
    inline sf_http_base_server::sf_http_base_server(const sf_http_server_config& config) :
        ...
        sf_bind_signal(&session_timer__, timeout, [this] {
            flush_session__();
        }, true);
    ...
    inline byte_array
    sf_http_base_server::append_multipart_data__(sf_multipart_data_context_t &multipart_data,
