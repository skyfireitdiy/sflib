...
namespace skyfire
{
    ...
    inline bool sf_static_router::run_route(const sf_http_request &req, sf_http_response &res, const std::string &raw_url,
    ...
    inline sf_static_router::sf_static_router(std::string path, std::vector<std::string> methods, std::string charset,
        ...
        callback__ =
                [=](const sf_http_request &req, sf_http_response &res, const std::string &url,
                            ...
                            if (range_content_list.size() < 2) {
                                ...
                                if (range_list.size() > 1) {
                                    ...
                                    for (auto &range_str:range_list) {
                                        ...
                                        tmp_part.file_info = sf_http_response::response_file_info_t{abs_path, start,
                                                                                                    end};
    ...
    inline int sf_static_router::get_priority() const {
        return priority__;
    }
