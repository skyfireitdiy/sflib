...
namespace skyfire {
    ...
    private:
        ...
        std::unordered_map<SOCKET, multipart_data_context_t> multipart_data_context__;
        ...
        byte_array append_multipart_data__(multipart_data_context_t &multipart_data, const byte_array &data);
