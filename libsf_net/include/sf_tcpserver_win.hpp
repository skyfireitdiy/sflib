...
namespace skyfire {
    ...
    inline void sf_tcpserver::server_work_thread__(LPVOID completion_port_id) {
    ...
    inline bool sf_tcpserver::send(SOCKET sock, int type, const byte_array &data) {
        DWORD sendBytes;
    ...
    inline bool sf_tcpserver::send(SOCKET sock, const byte_array &data) {
        DWORD sendBytes;
