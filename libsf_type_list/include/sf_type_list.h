...
namespace skyfire
{
    ...
    {
        using type = std::conditional_t<_Index == 0,
                _Type,
    ...
    template<
            ...
            typename ...  _Result
    >
    struct tl_left_helper<_Index, sf_type_list<_Type, _TypeList...>, sf_type_list<_Result...>>
    {
        using type =
        typename std::conditional<
                _Index == 0,
                sf_type_list<_Result...>,
                typename tl_left_helper<
                        _Index - 1,
                        sf_type_list<_TypeList...>,
                        sf_type_list<_Result..., _Type>
                >::type
        >::type;
    };

    template<typename _Type, typename ... _TypeList, typename ...  _Result>
    struct tl_left_helper<-1,
            sf_type_list<_Type, _TypeList...>,
            sf_type_list<_Result...>
    >
    {
    ...
    struct tl_left_helper<-1, sf_type_list<>, sf_type_list<_Result...>>
    {
        using type = sf_type_list<>;
    };

    template<>
    struct tl_left_helper<0, sf_type_list<>, sf_type_list<>>
    {
        using type = sf_type_list<>;
    };
    ...
    struct tl_right_helper<-1, sf_type_list<_Type, _TypeList ...>>
    {
        using type = sf_type_list<>;
    };

    template<int _Index, typename _Type, typename ... _TypeList>
    struct tl_right_helper<_Index, sf_type_list<_Type, _TypeList ...>>
    {
        using type = typename std::conditional<
                _Index == 0,
                sf_type_list<_Type, _TypeList...>,
                typename tl_right_helper<
                        _Index - 1,
                        sf_type_list<_TypeList...>
                >::type
        >::type;
    ...
    template<typename ... _TypeList>
    struct tl_right_helper<-1, sf_type_list<_TypeList ...>>
    {
        using type = sf_type_list<>;
    };

    template<>
    struct tl_right_helper<0, sf_type_list<>>
    {
        using type = sf_type_list<>;
    };
    ...
    template<typename _Itype, typename ... _TypeList>
    struct tl_push_front<_Itype, sf_type_list<_TypeList...>>
    {
        using type = sf_type_list<_Itype, _TypeList...>;
    };

    template<typename _Itype, typename ... _TypeList>
    struct tl_push_back<_Itype, sf_type_list<_TypeList...>>
    {
    ...
    template<int _Index, typename ... _TypeList>
    struct tl_get<_Index, sf_type_list<_TypeList...>>
    {
        using type = typename tl_get_helper<_Index, _TypeList...>::type;
    };

    template<typename _Type, typename ... _TypeList>
    struct tl_front<sf_type_list<_Type, _TypeList...>>
    {
        using type = _Type;
    };

    template<typename ... _TypeList>
    struct tl_back<sf_type_list<_TypeList...> >
    {
        using type = typename tl_get<
                sizeof...(_TypeList) - 1,
                sf_type_list<_TypeList...>
        >::type;
    };
    ...
    template<int _Index, typename ... _TypeList>
    struct tl_left<_Index, sf_type_list<_TypeList...>>
    {
        using type = typename tl_left_helper<
                _Index, sf_type_list<_TypeList...>,
                sf_type_list<>
        >::type;
    };
    ...
    template<int _Index, typename ... _TypeList>
    struct tl_right<_Index, sf_type_list<_TypeList...>>
    {
        using type = typename tl_right_helper<
                sizeof...(_TypeList) - _Index,
                sf_type_list<_TypeList...>
        >::type;
    };

    template<typename _Type, typename ... _TypeList>
    struct tl_pop_front<sf_type_list<_Type, _TypeList...>>
    {
        using type = sf_type_list<_TypeList...>;
    };

    template<typename ... _TypeList>
    struct tl_pop_back<sf_type_list<_TypeList...>>
    {
        using type = typename tl_left_helper<
                sizeof...(_TypeList) - 1,
                sf_type_list<_TypeList...>,
    ...
    template<typename ... _TypeList1, typename ... _TypeList2>
    struct tl_merge<sf_type_list<_TypeList1...>, sf_type_list<_TypeList2...>>
    {
        using type = sf_type_list<_TypeList1..., _TypeList2...>;
    };

    template<int _Index, int _Len, typename ... _TypeList>
    struct tl_erase<_Index, _Len, sf_type_list<_TypeList...>>
    {
    ...
    template<int _Index, int _Len, typename ...  _TypeList>
    struct tl_mid<_Index, _Len, sf_type_list<_TypeList ... >>
    {
    ...
    template<int _Pos, typename _Itype, typename ...  _TypeList>
    struct tl_insert<_Pos, _Itype, sf_type_list<_TypeList...>>
    {
        using type = typename tl_merge<
                ...
                >::type,
                typename tl_right<
                        sizeof...(_TypeList) - _Pos, sf_type_list<
                                _TypeList...>
                >::type
        >::type;
    };
