...
http_server_req_header http_server_req_multipart::header() const
{
    return header__;
}
bool http_server_req_multipart::is_end() const
{
    return end__;
}
bool http_server_req_multipart::is_finished() const
{
    return finish__;
}
std::string http_server_req_multipart::filename() const
{
    return filename__;
}
