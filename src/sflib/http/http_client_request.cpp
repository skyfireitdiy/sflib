...
std::shared_ptr<http_client_request> http_client_request::add_header(const std::string& key, const std::string& value)
{
    header__.set_header(key, value);
    return shared_from_this();
}
std::shared_ptr<http_client_request> http_client_request::add_cookies(const std::string& key, const std::string& value)
{
    header__.add_cookies(key, value);
    return shared_from_this();
}
std::shared_ptr<http_client_request> http_client_request::set_url(const std::string& url)
{
    // 忽略agreement
...
std::shared_ptr<http_client_request> http_client_request::set_method(const std::string& method)
{
    header__.get_request_line().method = method;
    return shared_from_this();
}
std::shared_ptr<http_client_request> http_client_request::set_file(const std::string& filename)
{
...
byte_array http_client_request::to_byte_array() const
{
    byte_array ret;
