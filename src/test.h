...
#define test_assert(exp)                                                                                 \
    if (!(exp))                                                                                          \
    {                                                                                                    \
        std::lock_guard<co_mutex> lck(skyfire::get_test_output_mu__());                                  \
...
#define test_np_neq(a, b)                                                                                      \
    {                                                                                                          \
        if ((a) == (b))                                                                                        \
        {                                                                                                      \
            std::lock_guard<co_mutex> lck(get_test_output_mu__());                                             \
            std::ostringstream        so;                                                                      \
