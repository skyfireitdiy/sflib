...
typename std::enable_if<N == sizeof...(_Types), byte_array>::type sf_serialize_tuple(const std::tuple<_Types...> &obj);
template <int N, typename... _Types>
typename std::enable_if<N != sizeof...(_Types), byte_array>::type sf_serialize_tuple(const std::tuple<_Types...> &obj);
template <typename... _Types>
byte_array sf_serialize(const std::tuple<_Types...> &obj);
template <int N, typename _Tuple_Type, typename... _Types>
typename std::enable_if<N == std::tuple_size<_Tuple_Type>::value, size_t>::type sf_deserialize_tuple(size_t pos, const byte_array &data, _Tuple_Type &obj, _Types... arg);
template <int N, typename _Tuple_Type, typename... _Types>
typename std::enable_if<N != std::tuple_size<_Tuple_Type>::value, size_t>::type sf_deserialize_tuple(size_t pos, const byte_array &data, _Tuple_Type &obj, _Types... arg);
