...
namespace skyfire
{
    ...
    template<int _Index, typename _New, typename _TypeList>
    using sf_tl_replace_index_t = typename sf_tl_replace_index<_Index, _New, _TypeList>::type;
    template<typename _TypeList>
    ...
    template<
            ...
            typename ...  _Result
    >
    struct sf_tl_left_helper<_Index, sf_type_list<_Type, _TypeList...>, sf_type_list<_Result...>>
    {
        using type =
        typename std::conditional<
                _Index == 0,
                sf_type_list<_Result...>,
                typename sf_tl_left_helper<
                        _Index - 1,
    ...
    >
    {
        using type = typename sf_tl_reverse_helper<
                sf_type_list<_TypeList1...>,
    ...
    {
        using type = typename sf_tl_left_helper<
    ...
    {
        using type = typename sf_tl_right_helper<
