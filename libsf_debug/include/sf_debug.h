    ...
    namespace
    {
        ...
        public:
            ...
            void logout(const std::string &file, int line, const std::string &func, const T &...dt)
            {
                ...
                {
                    std::lock_guard<std::recursive_mutex> lck(file_mutex__[curr_file__]);
                    fp__ << "[" << make_time_str__() << "][" << std::this_thread::get_id() << "][" << file << "]["
                         << line
                         << "][" << func << "]" << std::flush;
                }
                logout__(dt...);
            ...
            static void track(const std::string &file, int line, const std::string &func, const T &dt)
            {
                ...
                *p_os__ << "[" << make_time_str__() << "][" << std::this_thread::get_id() << "][" << file << "]["
                        << line
                        << "][" << func << "]";
                track__(dt);
            }
...
#define sf_track(...) __empty_func__(__VA_ARGS__)
        ...
        std::map<std::string, std::recursive_mutex> sf_debug::file_mutex__;


        std::ostringstream *sf_debug::p_os__ = new std::ostringstream();


        std::recursive_mutex sf_debug::__debug_mutex;


        std::function<void(const char *)> sf_debug::out_debug_str_func__ = __out_debug_string__;
