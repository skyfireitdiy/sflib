...
sf_tcp_error_trans::sf_tcp_error_trans(QTcpSocket* const p_sock, void(sftcp_server::*func)(QTcpSocket* const, QAbstractSocket::SocketError), sftcp_server *p_server, QObject* parent) :
