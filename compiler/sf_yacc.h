...
namespace skyfire
{
    ...
    class sf_yacc
    {
        ...
        static std::vector<std::pair<std::pair<std::set<sf_yacc_state_node_t>, std::string>, std::set<sf_yacc_state_node_t>>>
        nfa_to_dfa(
        ...
        static std::vector<std::pair<std::pair<std::string, std::string>, sf_yacc_state_node_t>> dfa_optimize(
        ...
        static std::vector<std::pair<std::pair<sf_yacc_state_node_t, std::string>, sf_yacc_state_node_t>>
        ...
        static std::vector<std::shared_ptr<sf_yacc_result_t>> make_yacc_result_from_lex_result(
                const std::vector<sf_lex_result_t> &lex_result);

        static bool self_reduce_two(std::vector<std::shared_ptr<sf_yacc_result_t>> &result,
                                    const std::vector<std::pair<std::pair<std::string, std::string>, sf_yacc_state_node_t>> &dfa,
                                    const std::unordered_set<std::string> &term_words);

        static bool self_reduce_one(std::vector<std::shared_ptr<sf_yacc_result_t>> &result,
                                    const std::vector<std::pair<std::pair<std::string, std::string>, sf_yacc_state_node_t>> &dfa);

        static bool reduce_new_node(std::vector<std::shared_ptr<sf_yacc_result_t>> &result,
                                    const std::shared_ptr<sf_yacc_result_t> &r_node,
                                    const std::vector<std::pair<std::pair<std::string, std::string>, sf_yacc_state_node_t>> &dfa,
                                    const std::unordered_set<std::string> &term_words);

        static bool add_new_node(std::vector<std::shared_ptr<sf_yacc_result_t>> &result,
                                 const std::shared_ptr<sf_yacc_result_t> &r_node,
                                 const std::vector<std::pair<std::pair<std::string, std::string>, sf_yacc_state_node_t>> &dfa);
