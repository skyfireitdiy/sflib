...
#pragma pack()
     ...
     * @return 包长度
     */
    unsigned long long sf_get_size(const sf_websocket_client_data_1_header_t &header) ;
     ...
     * @return 包长度
     */
    unsigned long long sf_get_size(const sf_websocket_client_data_2_header_t &header) ;
